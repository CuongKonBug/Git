...
<?php 
    ...
    $sql = "SELECT * FROM xuathoadon where iduser = $_SESSION[iduser] and trangthai = 'Đã nhận hàng'";
    $qr = mysqli_query($con,$sql);
    $kq = mysqli_fetch_assoc($qr);
    if($kq == 0){
      echo '<script language="javascript">alert("Chưa có món hàng nào"); window.location="nav.php";</script>';
    }
    else{
